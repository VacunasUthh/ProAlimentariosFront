...
import { confirmReturn, getAllLoansToReturn } from "../../../api/loans";
...
const Returns = () => {
    ...
    return (
        <div className='w-full sm:p-10 sm:px-20 p-5'>
            <Toaster richColors />
            <div className="">
                <p className="text-center text-3xl font-bold ">Devoluciones</p>
                                        ...
                                        {(columnKey) => (
                                            columnKey === 'acciones' ? (
                                                <TableCell className="text-center flex justify-center gap-3">
                                                    ...
                                                    <Button isIconOnly variant="flat" color="success">
                                                        {
                                                            <ModalAccept
                                                                handleFunction={handleAcceptRequest}
                                                                id={item?._id}
                                                                texto={`Estas apunto de confirmar la devolución del material para la practica ${item?.nombrePractica} del alumno ${item?.alumno?.nombre}.`}
                                                            />
                                                        }
                                                    </Button>
                                                </TableCell>
